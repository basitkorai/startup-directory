...
// Query: *[_type == "playlist" && slug.current == $slug][0]{  _id,  name,  slug,  select[]->{    _id,    _createdAt,    name,    slug,    author->{      _id,      name,      slug,      image,      bio    },    views,    description,    category,    image,    pitch  }}
